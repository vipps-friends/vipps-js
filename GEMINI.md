...
- **JSDoc over TypeScript**: The source code MUST be written in plain JavaScript with comprehensive JSDoc. TypeScript types (.d.ts) MUST be generated from these JSDoc comments.
